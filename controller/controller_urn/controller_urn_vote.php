...
$vote["idCandidate"] = "10";//$_POST["NAME NUMERO DO VOTO"]; // Pega o numero do candidato
$vote["idParty"] = "10";//$_POST["NAME ID PARTIDO"];         // Pega o numero do partido
$vote["idElection"] = "1";//$_POST["NAME ID ELEICAO"];	  // Pega o numero da eleição
